...
with_node \
  ...
  --target "/Users/scottymatthewman/Desktop/1 Projects/Slant/ios/Pods/Target Support Files/Pods-Slant/ExpoModulesProvider.swift" \
  --entitlement "/Users/scottymatthewman/Desktop/1 Projects/Slant/ios/Slant/Slant.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-audio" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-keep-awake" "expo-linking" "expo-router" "expo-splash-screen" "expo-sqlite" "expo-symbols" "expo-system-ui" "expo-web-browser"
